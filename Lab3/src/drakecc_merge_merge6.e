...
# 34 "merge.c"
int
merge_init_merge6(task_t *task, void* aux)
{
 link_t *link;
 array_int_t *tmp;
...
int
merge_start_merge6(task_t *task)
{
 link_t *link;
 int j;
...
int
merge_destroy_merge6(task_t *task)
{
