...
int
presort_init_leaf_5(task_t *task, void* aux)
{
 link_t *link;
 array_int_t *tmp;
...
int
presort_start_leaf_5(task_t *task)
{
 link_t *link;
 int j;
...
int
presort_run_leaf_5(task_t *task)
{
...
int
presort_kill_leaf_5(task_t *task)
{
...
int
presort_destroy_leaf_5(task_t *task)
{
