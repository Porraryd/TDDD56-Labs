...
# 34 "merge.c"
int
merge_init_merge3(task_t *task, void* aux)
{
 link_t *link;
 array_int_t *tmp;
...
int
merge_start_merge3(task_t *task)
{
 link_t *link;
 int j;
...
int
merge_destroy_merge3(task_t *task)
{
